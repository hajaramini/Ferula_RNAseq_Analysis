...
```{r}
Drap_Oases_Plant6.Bngo<-read.table("/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/hajaramini/Ferula_RNAseq_Analysis/GOseq_b2g_analysis/b2g_project_GO_final3",header=FALSE, stringsAsFactors = F) #add stringsAsFactors to fix the prob of creation list in next step
...
Drap_Oases_Plant6.cdna<-readDNAStringSet("/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/hajaramini/Ferula_RNAseq_Analysis/Goseq_Analysis/Drap_Oases_Plant6_No_Whitespace.fasta")
...
Drap_Oases_Plant6.Bngo<-read.table("/Network/Servers/avalanche.plb.ucdavis.edu/Volumes/Mammoth/Users/hajaramini/Ferula_RNAseq_Analysis/GOseq_b2g_analysis/b2g_project_GO_final3",header=FALSE, stringsAsFactors = F) # read Br_GO.txt in excel and save as csv
aaa <- as.list(Drap_Oases_Plant6.Bngo$V2)
names(aaa) <- Drap_Oases_Plant6.Bngo$V1
Drap_Oases_Plant6.Bngo.list <- aaa
dim(Drap_Oases_Plant6.Bngo) #47134  2
