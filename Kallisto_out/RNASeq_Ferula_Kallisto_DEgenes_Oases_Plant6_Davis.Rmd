...
write.csv(counts_Davis, file="~/Ferula_RNAseq_Analysis/Kallisto_out/Ferula_RNAseq_combined_drap_oases_plant6_Davis_small_counts_kallisto.csv") # use this for downstream analysis
```
