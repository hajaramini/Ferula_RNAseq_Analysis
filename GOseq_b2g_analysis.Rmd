...
DAVID_FvsL_BP <- DAVID_FvsL[c(1:2),]
DAVID_FvsL_CC <- DAVID_FvsL[3,]
DAVID_FvsL_MF <- DAVID_FvsL[c(4:6),]
#FvsR
DAVID_FvsR <- read.csv("~/GOseq_b2g_input_out/GO_FvsR", header = T,stringsAsFactors = F)
colnames(DAVID_FvsR) <- c("categoty","Term","over_represented_padjust")
DAVID_FvsR_BP <- DAVID_FvsR[c(1:5),]
DAVID_FvsR_CC <- DAVID_FvsR[c(6:10),]
DAVID_FvsR_MF <- DAVID_FvsR[c(11:14),]
#FvsR
...
DAVID_LvsR_BP <- DAVID_LvsR[c(1:6),]
DAVID_LvsR_CC <- DAVID_LvsR[c(7:13),]
DAVID_LvsR_MF <- DAVID_LvsR[c(14:19),]
#SvsR
...
#save
save(FvsR_LvsR_FvsS_FvsL_SvsR.gt.melt,file = "~/GOseq_b2g_input_out/FvsR_LvsR_FvsS_FvsL_SvsR.gt.melt.RData")
# 2) Plot 
...
FvsR_LvsR_FvsS_FvsL_SvsR.gt.melt.heatmap <- FvsR_LvsR_FvsS_FvsL_SvsR.gt.melt.heatmap + labs(y = "GO Term", x="Pairwise Comparison", title="Ferula assafoetida pairwise comparison GO Heatmap") 
