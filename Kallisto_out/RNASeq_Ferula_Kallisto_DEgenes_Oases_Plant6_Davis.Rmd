...
library(pvclust)
pdf(file = "~/Kallisto_input_out/heatmap_DE_Genes_CPM5.pdf",width = 10, height = 8)
hc.mds.dge <- hclust(dist(t(DE_Genes_CPMM)))
plot(hc.mds.dge)
#rect.hclust(hc.mds.dge, k = 3, border = "red")
...
#pdf(file ="~/Kallisto_input_out/Heatmap_DE_Genes_CPMM.pdf", height=8,width=8)
