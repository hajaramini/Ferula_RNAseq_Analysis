...
```{r}
violet.genesID <- read.table("~/WGCNA_input_out/Post_WGCNA_Analysis/violet.ModuleSelected.genesID_number.txt")
genelist <- violet.genesID$V2 
Drap_Oases_Plant6.GO.ORA.gt.violet <- Drap_Oases_Plant6.GOseq.Bn.ORA(genelist) #no enriched GO
